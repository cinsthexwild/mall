package com.earth.mall.interceptor;
...
import com.earth.mall.common.ReflectHelper;

/**
 * 插件支持MySQL和Oracle两种数据库，通过‘查询参数’或‘page属性’或‘params.page属性’是PageInfo的实例去匹配，是才进行分页处理；
 * 并且不用在Mapping中写分页代码。
 *
 * @author chenshixiong
 */
